...
namespace HouseRentalManagementSystem.Repository
{
    public class BuildingRepository : IBuildingRepository
    {
        ...
        public ApartmentBuildingViewModel Insert(ApartmentBuildingViewModel e)
        {
            ...
            Save();
            ApartmentBuildingViewModel obj1 = new ApartmentBuildingViewModel()
            {
        ...
        public ApartmentBuildingViewModel Update(ApartmentBuildingViewModel e)
        {
            ApartmentBuilding obj = new ApartmentBuilding()
            {
                BuildingId = e.BuildingId,
        ...
        public ApartmentBuildingViewModel Delete(int id)
        {
            ApartmentBuildingViewModel obj = GetById(id);
