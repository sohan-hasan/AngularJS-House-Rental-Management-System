...
namespace HouseRentalManagementSystem.IRepository
{
    public interface IBuildingRepository
    {
        ...
        ApartmentBuildingViewModel Insert(ApartmentBuildingViewModel e);
        ApartmentBuildingViewModel Update(ApartmentBuildingViewModel e);
        ApartmentBuildingViewModel Delete(int id);
        void Save();
    }
